...
public class PEnterConfChrome {
	...
	//public static final String cssAuthorization = "button[class*=\"big-button enter-conf\"]";	
	@FindBy(css = "a[href*='/service/authorization']")
	private WebElement pauthorization;
	
	//public static final String cssBigBlueeButton = "button[class*=\"big-button enter-conf\"]";	
	//public static final String idauthorization_b = "authorization-b";
	//@FindBy(id = "authorization-b");
	//private WebElement authorization-b;
	...
	public boolean login(String login, String password){
		driver.findElement(By.cssSelector("a[href*=\"authorization\"]")).click();		
	    driver.findElement(By.id("login")).clear();
	    driver.findElement(By.id("login")).sendKeys("admin");
	    driver.findElement(By.id("password")).clear();
	    driver.findElement(By.id("password")).sendKeys("admin");
	    driver.findElement(By.id("authorization-b")).click();
	    //driver.findElement(By.xpath("(//button[@type='button'])[5]")).click();
	    if(isElementPresent(driver.findElement(By.className("auth-logout")))){
			return true;
		}else {
			return false;
		}
