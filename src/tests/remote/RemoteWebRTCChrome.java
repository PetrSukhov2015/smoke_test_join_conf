...
public class RemoteWebRTCChrome {
  private WebDriver driver;
  private String baseUrl;
  private boolean acceptNextAlert = true;
  private StringBuffer verificationErrors = new StringBuffer();
  private static String nodeURL = "http://192.168.125.49:4444/wd/hub";
  ...
  public static void main(String[] args) throws Exception {
      ...
      JUnitCore.main(
        "tests.remote.RemoteWebRTCChrome");   
  ...
  public void setUp() throws Exception {
	  ...
	  //System.setProperty("webdriver.chrome.driver", "C:\\EclipseWS\\SmokeTest\\lib\\chromedriver.exe");
